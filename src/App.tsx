...
import ChangePasswordRedirect from './resetPassword/ChangepasswordRedirect';
import ChangePasswordInit from './resetPassword/ChangePasswordInit';
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/change_password" element={<ChangePasswordInit />} />
