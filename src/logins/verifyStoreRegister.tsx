...
const verifyRegistration = async (token: string): Promise<VerifyRegistrationResponse> => {
  const response = await fetch(`http://localhost:8080/api/v1/user/verifyRegistration?token=${encodeURIComponent(token)}`, {
    method: 'GET',
    headers: {
